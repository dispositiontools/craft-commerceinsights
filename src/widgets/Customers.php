...
use dispositiontools\commerceinsights\assetbundles\customerswidget\CustomersWidgetAsset;
...
class Customers extends Widget
{
    ...
    {
        return Craft::t('commerceinsights', 'Customers');
    }
    ...
    {
        return Craft::getAlias("@dispositiontools/commerceinsights/assetbundles/customerswidget/dist/img/Customers-icon.svg");
    }
    ...
    public function getSettingsHtml(): ?string
    {
        return Craft::$app->getView()->renderTemplate(
            'commerceinsights/_components/widgets/Customers_settings',
            [
                'widget' => $this
            ]
        );
    ...
    {
        Craft::$app->getView()->registerAssetBundle(CustomersWidgetAsset::class);

        return Craft::$app->getView()->renderTemplate(
            'commerceinsights/_components/widgets/Customers_body',
            [
