...
namespace dispositiontools\commerceinsights\widgets;

use dispositiontools\commerceinsights\Commerceinsights;
use dispositiontools\commerceinsights\assetbundles\transactionswidget\TransactionsWidgetAsset;

use Craft;
use craft\base\Widget;

/**
 * Commerceinsights Widget
 *
...
class Transactions extends Widget
{
    ...
    {
        return Craft::t('commerceinsights', 'Transactions');
    }
    ...
    {
        return Craft::getAlias("@dispositiontools/commerceinsights/assetbundles/transactionswidget/dist/img/Transactions-icon.svg");
    }
    ...
    public function getSettingsHtml()
    {
        return Craft::$app->getView()->renderTemplate(
            'commerceinsights/_components/widgets/Transactions_settings',
            [
                'widget' => $this
            ]
        );
    ...
    {
        Craft::$app->getView()->registerAssetBundle(TransactionsWidgetAsset::class);

        return Craft::$app->getView()->renderTemplate(
            'commerceinsights/_components/widgets/Transactions_body',
            [
