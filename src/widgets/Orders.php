...
use dispositiontools\commerceinsights\assetbundles\orderswidget\OrdersWidgetAsset;
...
class Orders extends Widget
{
    ...
    {
        return Craft::t('commerceinsights', 'Orders');
    }
    ...
    {
        return Craft::getAlias("@dispositiontools/commerceinsights/assetbundles/orderswidget/dist/img/Orders-icon.svg");
    }
    ...
    public function getSettingsHtml()
    {
        return Craft::$app->getView()->renderTemplate(
            'commerceinsights/_components/widgets/Orders_settings',
            [
                'widget' => $this
            ]
        );
    ...
    public function getBodyHtml()
    {
        ...
        return Craft::$app->getView()->renderTemplate(
            'commerceinsights/_components/widgets/Orders_body',
            [
