...
use dispositiontools\commerceinsights\assetbundles\productswidget\ProductsWidgetAsset;
...
class Products extends Widget
{
    ...
    {
        return Craft::t('commerceinsights', 'Products');
    }
    ...
    {
        return Craft::getAlias("@dispositiontools/commerceinsights/assetbundles/productswidget/dist/img/Products-icon.svg");
    }
    ...
    public function getSettingsHtml()
    {
        return Craft::$app->getView()->renderTemplate(
            'commerceinsights/_components/widgets/Products_settings',
            [
                'widget' => $this
            ]
        );
    ...
    {
        Craft::$app->getView()->registerAssetBundle(ProductsWidgetAsset::class);

        return Craft::$app->getView()->renderTemplate(
            'commerceinsights/_components/widgets/Products_body',
            [
